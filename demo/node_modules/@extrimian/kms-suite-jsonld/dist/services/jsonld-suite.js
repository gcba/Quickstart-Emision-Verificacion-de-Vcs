...
var JsonLDSuite = /** @class */ (function () {
    function JsonLDSuite() {
        ...
        this.customDocLoader = function (url) { return __awaiter(_this, void 0, void 0, function () {
            var did_1, vmId, didDocument, vm, field, vm_1, didDocument, response;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(url.indexOf('did:') > -1 && url.indexOf("#") > -1)) return [3 /*break*/, 2];
                        did_1 = url.substring(0, url.indexOf("#"));
                        vmId = url.substring(url.indexOf("#") + 1);
                        return [4 /*yield*/, this.cacheGetter(did_1, function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.didDocumentResolver(did_1)];
                                    case 1: return [2 /*return*/, _a.sent()];
                                }
                            }); }); })];
                    case 1:
                        didDocument = _a.sent();
                        vm = didDocument.verificationMethod.find(function (x) { return x.id == url; });
                        if (vm) {
                            return [2 /*return*/, {
                                    contextUrl: null,
                                    document: vm,
                        ...
                        for (field in didDocument) {
                            if ((0, util_1.isArray)(didDocument[field])) {
                                for (vm_1 in didDocument[field]) {
                                    if (didDocument[field][vm_1].id == url) {
                                        return [2 /*return*/, {
                                                contextUrl: null,
                                                document: didDocument[field][vm_1],
                                                documentUrl: url // this is the actual context URL after redirects
                                            }];
                                    }
                                }
