...
class WACIProtocol extends vc_protocol_1.VCProtocol {
    constructor(params) {
        ...
        this.businessVerificationRules = (_f = params.verifier) === null || _f === void 0 ? void 0 : _f.businessVerificationRules;
        ...
        if (this.presentationDefinition) {
            this.waciInterpreter.setUpFor({
                ...
                verifyPresentation: (p) => __awaiter(this, void 0, void 0, function* () {
                    const data = yield this.storage.get(p.message.thid);
                    const invitationId = data[0].pthid;
                    let result = yield this.agent.vc.verifyPresentation({
                        presentation: p.presentation,
                        challenge: p.challenge,
                    });
                    if (result.result && this.businessVerificationRules) {
                        let bvrResult = yield this.businessVerificationRules(invitationId, did_1.DID.from(p.holderDid), p.presentation);
