import { CredentialFulfillment, Actor, CredentialManifest, InputDescriptor, PresentationDefinitionFrame, WACIMessage } from '../types';
import { OfferCredentialMessageParamsBase } from '../handlers/issuance/step-3-propose-credential.handler';
export type Callback<TInput = any, TOutput = any> = (input: TInput) => Promise<TOutput>;
export type InputCallbacks = {
    [Actor.Holder]?: {
        getHolderDID: Callback<{
            message: WACIMessage;
        }, string>;
        ...
        handleCredentialFulfillment: Callback<{
            credentialFulfillment: CredentialFulfillment[];
            message: WACIMessage;
        }, boolean>;
        handlePresentationAck: Callback<{
            status: any;
            message: WACIMessage;
        }, void>;
    };
    [Actor.Issuer]?: {
        ...
        signCredential: Callback<{
            vc: any;
            message: WACIMessage;
        }, any>;
        verifyCredential: Callback<any, {
            result: boolean;
            error?: any;
        }>;
        credentialVerificationResult?: Callback<{
            result: boolean;
            error?: any;
            thid: string;
            vcs: any[];
...
export declare const callbacks: InputCallbacks;
