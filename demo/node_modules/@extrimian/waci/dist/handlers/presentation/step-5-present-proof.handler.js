            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, callbacks_1.callbacks[types_1.Actor.Verifier].verifyPresentation({ presentation: presentation, challenge: challengeToCheck, message: messageToProcess, holderDid: holderDID })];
                    case 1:
